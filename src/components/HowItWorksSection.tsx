    ...
    <section className="py-20 bg-gradient-to-b from-haive-dark to-haive-dark-purple" id="how-it-works">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <CollapsibleContent 
            summary={
              <span className="text-haive-teal text-lg font-medium">
                See how agent creation works (click to expand)
              </span>
            }
          >
            <div className="grid gap-8 md:grid-cols-3">
              <div className="p-6 bg-haive-dark-gray rounded-lg border border-haive-teal/20 hover:border-haive-teal/50 transition-all duration-300">
                <h4 className="text-xl font-bold mb-3">
                  <span className="text-haive-teal">1 · </span>
              ...
              <div className="p-6 bg-haive-dark-gray rounded-lg border border-haive-teal/20 hover:border-haive-teal/50 transition-all duration-300">
                <h4 className="text-xl font-bold mb-3">
                  <span className="text-haive-teal">2 · </span>
              ...
              <div className="p-6 bg-haive-dark-gray rounded-lg border border-haive-teal/20 hover:border-haive-teal/50 transition-all duration-300">
                <h4 className="text-xl font-bold mb-3">
                  <span className="text-haive-teal">3 · </span>
