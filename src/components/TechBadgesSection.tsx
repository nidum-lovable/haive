  ...
  return <section className="py-[5%] bg-black">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto my-4">
          {badges.map((badge, index) => <div key={index} className={`p-4 rounded-lg border border-gray-800 backdrop-blur-sm bg-haive-dark/60 hover:bg-haive-dark-gray/60 transition-all duration-300 flex items-start gap-4 group`}>
