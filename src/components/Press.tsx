        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pressItems.map((item, index) => (
              <div 
                key={index}
                className="p-6 rounded-lg bg-haive-dark-gray border border-gray-800 hover:border-haive-orange/30 transition-all duration-300"
              >
                ...
                <p className="text-sm text-haive-orange">— {item.publication}</p>
              </div>
            ))}
          </div>
        </div>
