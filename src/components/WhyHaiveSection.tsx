...
const WhyHaiveSection = () => {
  return (
    <section className="py-16 bg-haive-dark" id="why-haive">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div 
              key={index}
              className="p-6 rounded-lg bg-haive-dark-purple border border-haive-teal/10 hover:border-haive-teal/30 transition-all duration-300 group"
            >
